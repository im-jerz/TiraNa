...
import { getSupportTickets, updateTicket } from '../../api/admin'
...
export default function AdminSupport() {
  ...
  const fetchTickets = useCallback(async () => {
    setLoading(true)
    try {
      const data = await getSupportTickets({ status: statusFilter, priority: priorityFilter, search, limit: 100 })
        ...
        <div className="modal-overlay open" onClick={(e) => { if (e.target === e.currentTarget) setSelected(null) }}>
          <div className="modal modal-lg">
            ...
            <div className="info-grid">
              ...
              <div className="info-item"><p>Requester</p><p>{selected.requester_name || '—'}{selected.requester_email ? ` (${selected.requester_email})` : ''}</p></div>
